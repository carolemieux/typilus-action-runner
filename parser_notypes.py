...
class Parser:
    ...
    def func_api(self, root, name, nodes,
                 returns, *,
                 has_self, cls_method):
        """Create function API."""
        args = []
    ...
    def class_api(self, root, name, bases,
                  body):
        """Create class API."""
    ...
    def load_docstring(self, root, m):
    ...
    def __is_immediate_family(self, n1, n2):
